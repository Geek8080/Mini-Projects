...
public class Galaga_Game extends Application {
    ...
    final int MAX_BOMBS = 10, MAX_SHOTS = 2 * MAX_BOMBS;
    ...
    public void start(Stage stage) throws Exception {
        ...
        canvas.setOnMouseMoved(e -> mouseX = e.getX() - PLAYER_SIZE);
        ...
        stage.setTitle("G A L A G A       G A L A C T I C A");
        stage.show();

        Sounds.playBackground("battlestar.mid");
